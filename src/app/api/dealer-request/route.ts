...
const RESEND_TEST_EMAIL = process.env.RESEND_TO_EMAIL ?? "tvscertified@gmail.com";
...
Pincode: ${payload.pincode}
  ...
  //     <h2>New Become a Member Submission</h2>
  //     <p><strong>Company Name:</strong> ${payload.company_name}</p>
  //     <p><strong>Contact Person:</strong> ${payload.contact_person_name}</p>
  //     <p><strong>Email:</strong> ${payload.email}</p>
  //     <p><strong>Phone Number:</strong> ${payload.phone_number}</p>
  //     <p><strong>State:</strong> ${payload.state}</p>
  //     <p><strong>City:</strong> ${payload.city}</p>
  //     <p><strong>Pincode:</strong> ${payload.pincode}</p>
  //   </div>
  // `;
    ...
    <div style="padding:20px; color:#333;">
      ...
      <table style="width:100%; border-collapse:collapse; margin-top:15px;">
        <tr>
          ...
          <td style="padding:8px 0;">${payload.company_name}</td>
        </tr>
        <tr>
          <td style="padding:8px 0; font-weight:bold;">Contact Person:</td>
          <td style="padding:8px 0;">${payload.contact_person_name}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="padding:8px 0;">${payload.phone_number}</td>
        </tr>
        <tr>
          <td style="padding:8px 0; font-weight:bold;">State:</td>
          <td style="padding:8px 0;">${payload.state}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="padding:8px 0; font-weight:bold;">Pincode:</td>
          <td style="padding:8px 0;">${payload.pincode}</td>
        </tr>
      </table>
